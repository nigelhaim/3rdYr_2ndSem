...
| A comprehensive analysis of deep neural- based cerebral microbleeds detection systems                                 | Ferlin, M., Klawikowska, Z., Grochowski, M., Grzywińka, M., Szurowska, E. (2023) | Their proposed model achieved with a precision of 89.74%, a sensitivity rate of 92.62%, and a F1 score of 90.84%                                                                                                                                                                                 | Their findings would serve a great value to people who are studying in cerebral microbleeds. It could become a catalyst for better practices in the field. |
| A Computer Aided Detection System for Cerebral Micro                                                                  | Vrooman, H., Lugt, A., Niessen, W. (2012)                                        | They proposed a CAD system to detect CMBs. Their pre-processing method included skull-stripping. Initial candidates will be selected to be followed by reducing false-positives before determining the anatomical location of the CMBs.                                                          | The model achieved 90% CMB detection sensitivity with 4 false-positives per subject.                                                                       |
